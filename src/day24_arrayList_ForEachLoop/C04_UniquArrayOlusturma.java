...
public class C04_UniquArrayOlusturma {
    public static void main(String[] args) {
        //verilen bir arraydeki tekrar eden  elementleri tek bir defa barindiran
        //yeni bir array olarak donduren method olusturalim
        //unique:
