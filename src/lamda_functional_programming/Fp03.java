...
public class Fp03 {
    public static void main(String[] args) {
        ...
        System.out.println("uzunluk 12 den azmi:"+uzunluk12denAzMi(liste));
        System.out.println("x ile baslamiyorMu:"+xIleBaslamiyorMu(liste));
        System.out.println("r ile mi bitiyor:"+rIleMiBitiyor(liste));
...
//tum elemanlarin uzunluklarinin 12 den az olup plmadigini kontrol eden method olusturunuz
    public static boolean uzunluk12denAzMi(List<String> list){

     return list.stream().allMatch(t-> t.length()<12);

    }
    //hicbir elemanin x ile baslamadigini kont eden method olusturun
    public static boolean xIleBaslamiyorMu(List<String> list){
      return   list.stream().noneMatch(t-> t.startsWith("X")||t.startsWith("x"));
    }
    //herhangi bir elemanin r ile bitip bitmedigini kontrol ediniz
    public static boolean rIleMiBitiyor(List<String> list){
