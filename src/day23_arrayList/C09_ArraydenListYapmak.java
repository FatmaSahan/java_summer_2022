...
public class C09_ArraydenListYapmak {
    public static void main(String[] args) {
        int[] arr={3,5,6,8,2,12,10,9};
        //bu arrayi yeni bir  arry liste ekleyelim.tek tekeklemek yerine
        //bir list olusturup yapalim
        List<Integer> sayilar=new ArrayList<>();
        for (int i = 0; i <arr.length ; i++) {
            sayilar.add(arr[i] );
         //ONEMLIIIII:makul olan yontem bu for lu yontemdir.asgidaki yontemin hatalariolabilir
         ...
         */
        List<Integer> sayilar2= Arrays.asList();
