...
public class C03_Exceptions {
    public static void main(String[] args) {
        ...
        /*
        Kullanicidan String olarak degre alip bunu int ceviriyorsak
        NumberFormatExceptionla karsilasiriz.bu sorunla karsilastigimizda kodun durmasini istemiyorsak
